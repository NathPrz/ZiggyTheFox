...
public class MenuManager : Manager<MenuManager>
{
    ...
    [SerializeField] GameObject m_PanelLoading;
	...
	public override void SubscribeEvents()
	{
        ...
        EventManager.Instance.AddListener<RestartButtonClickedEvent>(GameRestart);
	...
	public override void UnsubscribeEvents()
	{
        ...
        EventManager.Instance.RemoveListener<RestartButtonClickedEvent>(GameRestart);

        EventManager.Instance.RemoveListener<NextLevelEvent>(NextLevel);
    }
	#endregion
	...
	void RegisterPanels()
	{
        ...
        m_AllPanels.Add(m_PanelLoading);
    ...
    public void GameRestart(RestartButtonClickedEvent e)
    {
		OpenPanel(m_PanelLoading);
    }

    public void NextLevel(NextLevelEvent e)
    {
        OpenPanel(m_PanelLoading);
    }
    #endregion
