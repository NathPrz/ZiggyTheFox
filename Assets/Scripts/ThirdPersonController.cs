...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        [Tooltip("Pushing force of the character")]
        ...
        private void Attack()
        {
            ...
            {               
                ...
                Vector3 tornadoPosition = transform.TransformPoint(new Vector3(0f, -1.5f, 0f));
                Instantiate(tornado, tornadoPosition, tornado.transform.rotation);
            }
            else
            {           
                if (_hasAnimator)
